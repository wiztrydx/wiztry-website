...
![ChatGPTはこう変わった。これまでのChatGPTは質問に答える相談相手で、返ってくるのは文章。ChatGPT Workは仕事を任せると納品する部下で、資料・表・レポートを完成形で返してくる](/blog/chatgpt-work-kaisetsu/diagram-1-henka.webp)
...
![3つのモードの使い分け。Chatはその場で答えがほしいとき（数秒）、Workは形にして持ってきてほしいとき（数分〜数時間）、Codexはプログラムを作る・直すとき（エンジニア向け）](/blog/chatgpt-work-kaisetsu/diagram-2-modes.webp)
...
![頭脳は3種類どう選ぶ？Solはここ一番の勝負どころ、Terraは普段の主力で迷ったらこれ、Lunaは量をこなす定型仕事。無料プランで使えるのはTerraのみ](/blog/chatgpt-work-kaisetsu/diagram-3-models.webp)
...
![使う場所でできることが違う。Web版・スマホ版はクラウド上で動きPCを閉じても作業が続く。デスクトップ版はPC内のファイルやブラウザも操作できる（許可した範囲だけ）](/blog/chatgpt-work-kaisetsu/diagram-4-basho.webp)
...
![スキルとAGENTS.mdの違い。スキルは業務マニュアルで時々呼び出す仕事のやり方、AGENTS.mdは就業規則で毎回必ず守る仕事のルール。2つを整備した会社ほど成果物が安定する](/blog/chatgpt-work-kaisetsu/diagram-5-skills.webp)
...
![安全に使う4つのルール。1: 許可は最小限のフォルダだけ、2: 消えて困るものはバックアップ、3: 数字と固有名詞は人間が検証、4: 機密情報は入れない](/blog/chatgpt-work-kaisetsu/diagram-6-rules.webp)
...
![最初の2週間の進め方。1〜3日目はまず1人で試す、4〜7日目は依頼の型を作る、2週目は仕事を1つスキル化する](/blog/chatgpt-work-kaisetsu/diagram-7-steps.webp)
